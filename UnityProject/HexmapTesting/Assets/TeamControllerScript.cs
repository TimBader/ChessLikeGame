...
public class TeamColorPallet : MonoBehaviour
{
    public static void initalizeColorPallets()
    {
        teamPallets = Util.toList( new TeamColorPallet[]
        {
            ...
            //Team 0 Colors
            new TeamColorPallet(hexColor(0xff, 0, 0), hexColor(0x05, 0x2e, 0x95), hexColor(0x93,0x98,0xc8), hexColor(0x2e, 0x95, 0x05)),
            //Team 1 Colors
            new TeamColorPallet(hexColor(0, 0, 0xff), hexColor(0xff, 0x09, 0x09), hexColor(0x3b, 0x3b, 0x3b), hexColor(0x71, 0x05, 0x95)),
        });
    }
